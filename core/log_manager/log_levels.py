...
from config.settings import path_lost_ids
...
@singleton
class LoggerLostIDS(object):

    def __init__(self):
        log_type = 'core_services_lost_ids'
        setup_logger(log_type, path_lost_ids, logging.INFO)
        self.log = logging.getLogger(log_type)
        self.log.info('*** Start CoreServices lost ids Logs ***')
